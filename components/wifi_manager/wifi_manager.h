/*
Revised from https://github.com/tonyp7/esp32-wifi-manager/src/wifi_manager.h
 ...
 */
	...
	#endif
	#ifdef CONFIG_MDNS_ADD_ADDITIONAL_SUFFIX_TO_HOSTNAME
		#define MDNS_ADD_ADDITIONAL_SUFFIX 1
		#define MDNS_SUFFIX_FROM_NVS_NAMESPACE CONFIG_MDNS_ADD_SUFFIX_FROM_NVS_NAMESPACE
		#define MDNS_SUFFIX_FROM_NVS_KEY CONFIG_MDNS_ADD_SUFFIX_FROM_NVS_KEY
	#else
		#define MDNS_ADD_ADDITIONAL_SUFFIX 0
	#endif
#else
